...
- **Selected Schemes (5):** Covering large-cap, mid-cap, small-cap, and commodity (gold/silver) categories for diversity:

| # | Scheme Name | Category | Groww URL |
|---|---|---|---|
| 1 | HDFC Large Cap Fund – Direct Growth | Large Cap | [Link](https://groww.in/mutual-funds/hdfc-large-cap-fund-direct-growth) |
| 2 | HDFC Mid Cap Fund – Direct Growth | Mid Cap | [Link](https://groww.in/mutual-funds/hdfc-mid-cap-fund-direct-growth) |
| 3 | HDFC Small Cap Fund – Direct Growth | Small Cap | [Link](https://groww.in/mutual-funds/hdfc-small-cap-fund-direct-growth) |
| 4 | HDFC Gold ETF Fund of Fund – Direct Growth | Gold (Commodity) | [Link](https://groww.in/mutual-funds/hdfc-gold-etf-fund-of-fund-direct-plan-growth) |
| 5 | HDFC Silver ETF FoF – Direct Growth | Silver (Commodity) | [Link](https://groww.in/mutual-funds/hdfc-silver-etf-fof-direct-growth) |

- **Corpus Sources:** The following **5 Groww scheme pages** (listed above) serve as primary data sources. Additional official documents to be collected per scheme:

| Source Type | Description | Origin |
|---|---|---|
| Scheme Factsheets | Monthly performance & portfolio data | HDFC AMC website |
| KIM (Key Information Memorandum) | Key scheme details & risk factors | HDFC AMC website |
| SID (Scheme Information Document) | Detailed scheme objectives & policies | HDFC AMC website |
| AMC FAQ / Help Pages | Common investor queries & processes | HDFC AMC website |
| AMFI Guidance Pages | Industry-level mutual fund education | [amfiindia.com](https://www.amfiindia.com) |
| SEBI Regulations | Regulatory framework & investor protection | [sebi.gov.in](https://www.sebi.gov.in) |
| Statement & Tax Guides | How to download CAS, capital gains reports | HDFC AMC / CAMS / KFintech |
...
| SIP details | Minimum SIP amount |
